 ...
 * MyBatis-Plus 代码生成类
 */
public class CodeGeneratorWemedia {

	private static final String PACKAGE_NAME = "com.heima";
	private static final String MODEL_NAME = "wemedia";

	private static final String DB_URL  = "jdbc:mysql://192.168.200.130:3306/leadnews_wemedia?useUnicode=true&useSSL=false&characterEncoding=utf8";
	...
	//嵌套工程
	private static final String projectPath = System.getProperty("user.dir")+
			File.separator+"heima-leadnews-service"+File.separator+"heima-leadnews-wemedia";
